...
const BAT_SPRITE = preload("res://assets/enemies/tile_0120.png")
const GHOST_SPRITE = preload("res://assets/enemies/tile_0121.png")
const SPIDER_SPRITE = preload("res://assets/enemies/tile_0122.png")
